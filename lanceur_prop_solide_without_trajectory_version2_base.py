# -*- coding: utf-8 -*-
"""
  lanceur_prop_solide_without_trajectory_version2_base.py generated by WhatsOpt 1.9.4
"""
...
class LanceurPropSolideWithoutTrajectoryVersion2Base(Group):
    ...
    def setup(self): 
        ...
        self.add_subsystem('Solid', self.create_solid(), promotes=['beta', 'De', 'Ds', 'Dt', 'FF', 'f_safety', 'Lconv', 'Ldiv', 'Lfrust', 'L_SRM', 'Mcarter', 'Minsulation', 'Mnozzle', 'M_CaseBody', 'M_CaseFrust', 'M_CaseTop', 'M_InsulationBody', 'M_InsulationTop', 'M_SRM', 'Pc', 'prop_m', 'rho', 'rho_in', 'rho_p', 'Ru', 'SF', 'sigma', 't', 'tb', 'theta_n'])
