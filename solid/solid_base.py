# -*- coding: utf-8 -*-
"""
  solid_base.py generated by WhatsOpt 1.9.3
"""
...
class SolidBase(Group):
    ...
    def setup(self): 
        ...
        self.add_subsystem('Mcase', self.create_mcase(), promotes=['Dnozzle', 'Ds', 'f_safety', 'Lcase', 'Lfrust', 'Mcarter', 'Mcase', 'Minsulation', 'M_CaseBody', 'M_CaseFrust', 'M_CaseTop', 'M_InsulationBody', 'M_InsulationTop', 'Pc', 'rho', 'rho_in', 'sigma', 't'])
